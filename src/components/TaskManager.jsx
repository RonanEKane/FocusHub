...
const TaskManager = ({ onTaskComplete }) => {
  ...
  const handleDrop = (e, toCategory) => {
    ...
    setTasks(prev => ({
      ...prev,
      [fromCategory]: prev[fromCategory].filter(t => t.id !== task.id),
      [toCategory]: [...prev[toCategory], task]
    }));
            ...
            <div className="task-list">
              {tasks.holding.map(task => (
                <div 
                  ...
                  className="task-item"
                  draggable
                  onDragStart={(e) => handleDragStart(e, task, 'holding')}
              ...
              <div className="task-list">
                {tasks[cat.key].map(task => (
                  <div 
                    ...
                    className="task-item"
                    draggable
                    onDragStart={(e) => handleDragStart(e, task, cat.key)}
                    onDragEnd={handleDragEnd}
                  >
                    <div className="task-content">
                      <div className="task-text">{task.text}</div>
